    ...
    <article className="overflow-hidden rounded-boutique border border-pink-100 bg-white shadow-soft">
      <Link href={`/shop/${product.slug}`} className="group block">
        <div className="relative aspect-[4/3] overflow-hidden bg-aqua-50">
          ...
          />
          <span className="absolute left-3 top-3 max-w-[calc(100%-1.5rem)] rounded-full border border-white bg-white px-3 py-1 text-xs font-black text-boutique-charcoal shadow-pink ring-1 ring-boutique-charcoal/10 backdrop-blur">
