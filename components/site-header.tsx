...
export function SiteHeader() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-pink-100 bg-white/95 shadow-sm backdrop-blur supports-[backdrop-filter]:bg-white/85 md:sticky md:inset-x-auto">
