...
export default async function AdminOrdersPage() {
  ...
  return (
    <div>
      <AdminPageHeader title="Orders" eyebrow="Commerce" description="Track Square-hosted checkout orders and fulfillment status. Webhook-powered capture is prepared for Phase 2." />
      <div className="space-y-3">
        ...
        {orders.length === 0 && <AdminCard><p className="text-sm text-boutique-charcoal/60">No orders yet. Checkout is Square-hosted; Phase 2 webhooks can populate this table automatically.</p></AdminCard>}
      </div>
    </div>
  );
}
