  ...
  return (
    <section className="container-page grid gap-8 py-10 lg:grid-cols-[0.9fr_1.1fr]">
      ...
      <ManagedForm action={submitContactMessage} submitLabel="Send message">
        ...
        <input name="phone" placeholder="Phone" className="focus-ring w-full rounded-xl border border-pink-100 px-4 py-3" />
        <textarea name="message" required rows={6} placeholder="How can we help?" className="focus-ring w-full rounded-xl border border-pink-100 px-4 py-3" />
